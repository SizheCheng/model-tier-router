"""Local, redacted Codex lifecycle collection for Router evaluation."""
    ...
    if name == "SessionStart":
        response = {
            ...
            "hookSpecificOutput": {
                ...
                "additionalContext": (
                    "Managed model-tier-router development-data collection is active for this "
        ...
        response = {
            "hookSpecificOutput": {
                ...
                "additionalContext": "The managed development-data collector also covers this subagent.",
            }
        }
...
def _failure_response(event_name: str | None, reason: str, event: dict[str, Any] | None) -> dict[str, Any]:
    message = f"Managed model-tier-router development-data collection failed: {reason}"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="model-tier-router-codex-hook")
